...
@receiver(signals.post_save, sender=ModeratorCommentStatement)
def send_moderator_comment_statement_notification(instance, **kwargs):
    emails.NotifyCreatorOnModeratorCommentStatement.send(instance)
