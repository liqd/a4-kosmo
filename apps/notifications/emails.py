...
class NotifyCreatorOnModeratorBlocked(Email):
    template_name = \
        'a4_candy_notifications/emails/notify_creator_on_moderator_blocked'
    ...
    def get_netiquette_url(self):
        ...
        if organisation.netiquette:
            return reverse('organisation-netiquette', kwargs={
                'organisation_slug': organisation.slug
            })
        elif getattr(important_pages, 'netiquette') and \
                getattr(important_pages, 'netiquette').live:
...
class NotifyCreatorOnModeratorCommentStatement(Email):
    template_name = 'a4_candy_notifications/emails' \
                    '/notify_creator_on_moderator_comment_statement'
    ...
    def get_context(self):
        ...
        context['moderator_statement'] = self.object.statement
